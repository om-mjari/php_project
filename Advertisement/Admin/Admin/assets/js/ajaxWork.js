...
//    // This will ensure that when the page is fully loaded, this code will be executed
...
//        fd.append('suit', $('#suit').val());
//        fd.append('shape', $('#shape').val());
//        fd.append('brand', $('#brand').val());
//        fd.append('age', $('#age').val());
//        fd.append('p_quantity', $('#p_quantity').val());
//        fd.append('p_weight', $('#p_weight').val());
//        fd.append('p_size', $('#p_size').val());
...
//                alert(response); // Show the server response in an alert
//                $('#productForm')[0].reset(); // Reset the form fields after success
//                $('#myModal').modal('hide'); // Close the modal
//            },
//            error: function() {
//                alert("Error adding product."); // Show an error alert
//            }
//        });
//    });
//});
...
function itemEditForm(id) {
    $.ajax({
        url: "./controller/fetchItemController.php",
        method: "POST",
        data: {record: id},
        success: function (data) {
...
function sizeUpdate(ID) {
    $.ajax({
        url: "./controller/EmpUpdateSalary.php",
        method: "post",
        data: {record: ID},
        success: function (data) {
            alert('Employee Salary Successfully updated');
            $('form').trigger('reset');
            showSizes();
        }
    });
