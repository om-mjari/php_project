                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="contact-info">
                            <h2>Our Office</h2>
                            <h3><i class="fa fa-map-marker"></i>6/1638,Lal darwaja ,Surat.</h3>
                            <h3><i class="fa fa-envelope"></i>speczone2024@gmail.com</h3>
                            <h3><i class="fa fa-phone"></i>+91 63593 47716</h3>
                            <div class="social">
